...
def do_daily(today):
    ...
    yesterday_gain, yesterday_loss = booking_dao.gain_cancelled_in_range(
        yesterday_start_created, yesterday_end_created
    )
    ...
    return (
        yesterday_end_created.date(),
        yesterday_gain,
        yesterday_loss,
        recurring_customer_count - todays_nett,
    )
