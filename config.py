...
class Config:
    ...
    GMAIL_SERVICE_ACCOUNT_CREDENTIALS = os.environ.get(
        "GMAIL_SERVICE_ACCOUNT_CREDENTIALS"
    )
    ...
    CUSTOM_INVOICE_REFERENCE_EXTRA = os.environ.get(
    ...
    SALES_RESERVATION_CATEGORY = os.environ.get(
        "SALES_RESERVATION_CATEGORY", "Sales Reservation"
    )
